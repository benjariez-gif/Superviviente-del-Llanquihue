...
define config.name = _("Superviviente del llanquihue")
...
define build.name = "Supervivientedelllanquihue"
...
define config.save_directory = "Supervivientedelllanquihue-1778717139"
